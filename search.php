                                    ...
                                    <div class="inner-content clearfix">
                                        ...
                                        <div class="post-information">
                                            ...
                                            <span>
                                                ...
                                                <a href='author.php?aid=<?php echo $row['post.author'];?>'><?php echo $row['username'];?></a>
                                            </span>
                                            <span>
...
$result1 = mysqli_query($conn,$sql1) or die("connection failed not good ");
...
if($page>1){
   ...
   if($total_page>$page){
   echo'<li><a href="index.php?search'.$search_term.'&page='.($page+1).'">NEXT</a>';
   }
   echo '</ul>';
 }
}else{
